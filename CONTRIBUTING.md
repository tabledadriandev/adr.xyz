Thanks for your interest on contributing to adr.xyz. The guidelines for doing such are explained below, they're usually pretty simple, and most of
...
* Refactor - Refactors a part of adr.xyz's code.
* Chore - Probably just a dependency bump-, or fixes to the docker/CI configs.

And module can be:
* Any command (mine, fish, profile, etc)
* A internal part of adr.xyz (cc, evalsystem, finderutil, core, command, option)
* A external part included on adr.xyz's code (lavalink-client)
