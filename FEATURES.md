...
*   Feeling lucky? Try guessing a number adr.xyz thinks of! `~>game number`
...
Invite adr.xyz to your own server now!: https://add.adr.xyz/

## Some of adr.xyz's commands include (but are not limited to)
...
*   **Currency Commands** (`badges balance cast chop daily dailycrate equip fish gamble inventory iteminfo itemtransfer leaderboard level loot market mine opencrate pet profile rep repair salvage slots transfer unequip useitem`):
    A fully-featured currency system in adr.xyz. Be one of the richest people in the global position and enjoy mining, looting, fishing, chopping, playing with pets and achievements!
